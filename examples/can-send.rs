...
fn main() -> ! {
    ...
    let mut can1 = {
        ...
        let can = Can::new(dp.CAN1, (rx, tx), &mut rcc.apb1);
    ...
    let can2 = {
        let rx = gpiob.pb13.into_alternate_af9();
        let tx = gpiob.pb12.into_alternate_af9();

        let can = Can::new(dp.CAN2, (rx, tx), &mut rcc.apb1);
